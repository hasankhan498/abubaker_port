  ...
  return (
    <section className="relative overflow-hidden bg-[radial-gradient(circle_at_top_right,#0d4b3b_0%,#04152d_35%,#021330_70%)] py-32">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
        ...
        >
            Our portfolio showcases a diverse range of projects, each reflecting our commitment to quality, innovation, and client satisfaction. From web applications to mobile solutions, we take pride in delivering results that exceed expectations.
        </motion.p>
